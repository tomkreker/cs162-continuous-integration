...
r = requests.post('http://localhost:5000/add', data = {'expression': '1+2+3'})
...
con_string = 'postgres+psycopg2://cs162_user:cs162_password@localhost:5432/cs162'
...
# post faulty query
r2 = requests.post('http://localhost:5000/add', data = {'expression': '1///2+3'})
